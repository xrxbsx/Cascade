 ...
 */
public class CryptoClientConfig extends ClientConfig {

    public CryptoClientConfig(Protocol protocol) {
        ...
        // If you use for example xor you can generate a key with your chosen size
